...
class DecisionEngine:
    def __init__(self, cores_per_node=4.0, max_workers=2, min_workers=1, scale_out_percent=0.80):
        # Configuration
        ...
        # Thresholds
        self.scale_out_percent = scale_out_percent  # Scale Out when predicting > 80% of current capacity 
